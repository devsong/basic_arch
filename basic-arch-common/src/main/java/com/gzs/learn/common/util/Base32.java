...
public final class Base32 {
    ...
    protected static final String BASE_STR_OUTPUT = "0123456789ABCDEFGHJKLMNPQRSTUWXY";

    /**
     * 字符映射。
     */
    protected static final char[] CHAR_SET_STD = BASE_STR_OUTPUT.toCharArray();
    ...
    private static final String[] LIST_STR_ZERO = { "0", "0", "00", "000", "0000", "00000", "000000", "0000000", "00000000", "000000000",
     ...
     *             offset < 0 || length < 0 || offset + length > data.length 时, 抛出该异常。
     */
    public static final String encodeBytesToBase32(byte[] data, int offset, int length)
     ...
     *             offset < 0 || length < 0 || offset + length > data.length 时, 抛出该异常。
     */
    public static final int encodeBytesToBase32(byte[] data, int offset, int length, StringBuilder buff)
            throws NullPointerException, IndexOutOfBoundsException {
        if (0 == length) {
            return 0;
        }
     ...
     */
    public static final int decodeBase32ToBytes(String data, byte[] buff, int offset_buff)
            throws NullPointerException, IndexOutOfBoundsException {
     ...
     */
    public static final byte[] decodeBase32ToBytes(byte[] data, int offset_data, int length_data)
            throws NullPointerException, IndexOutOfBoundsException {
        if (0 == length_data) {
            return null;
        }
