package com.ruoyi.leaf.server.controller;
...
import com.ruoyi.leaf.segment.model.SegmentBuffer;
import com.ruoyi.leaf.server.model.SegmentBufferView;
import com.ruoyi.leaf.server.service.SegmentService;
...
public class LeafMonitorController {
    ...
    public Map<String, String> decodeSnowflakeId(@RequestParam("snowflakeId") String snowflakeIdStr) {
        ...
        try {
            ...
            long originTimestamp = (snowflakeId >> 22) + IDGen.EPOCH;
