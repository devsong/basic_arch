...
public class ServiceConfig {
    ...
    public void init() {
        ...
        imports.add("com.gzs.learn.web.modular." + contextConfig.getModuleName() + ".service.I" + contextConfig.getBizEnBigName() + "Service");
        ...
        this.packageName = "com.gzs.learn.web.modular." + contextConfig.getModuleName() + ".service";
    }
